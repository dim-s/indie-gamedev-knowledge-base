...
См. [TL;DR](OGD.md#ogd-tldr), [типы игр](OGD.md#ogd-game-types), [пять сфер](OGD.md#ogd-spheres), [агентность и инструменты](OGD.md#ogd-agency-tools).
...
См. [TL;DR](OGD.md#ogd-tldr) и [протокол применения](OGD.md#ogd-protocol-application).
...
См. [типы игр](OGD.md#ogd-game-types), [словарь механик → глаголы](OGD.md#ogd-mechanics-glossary), [маркетинг](OGD.md#ogd-marketing-homeostasis).
...
См. [что определяет тип игры](OGD.md#ogd-game-types-contents), [как выбирать глагол](OGD.md#ogd-mechanics-ambiguous), [цена входа](OGD.md#ogd-inertia-entry).
