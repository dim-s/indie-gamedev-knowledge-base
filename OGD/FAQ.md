...
OGD называет это Правилом Когерентности: сенсорный профиль игры должен совпадать с её вектором. Чтобы Инструмент сработал, он должен быть физически подтверждён.

См. [сенсорный слой и Game Feel](OGD.md#ogd-sensory-layer) и [правило когерентности](OGD.md#ogd-sensory-noise).
