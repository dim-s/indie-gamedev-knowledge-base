...
Углубления в отдельные аспекты разработки. Каждый модуль опирается на ядро OGD и закрывает свой микро-уровень проектирования.

- **[`Pacing.md`](./Pacing.md)** — *Пейсинг.* Ритм и распределение событий в моменте: как настроить пять слоёв опыта, чтобы игрок не уставал от хаоса и не засыпал от порядка. Принцип Убывающей Редкости, рассинхронизация слоёв, калибровка по трёхуровневой оси Вектор → Сфера → Инструмент.
- **[`Progression.md`](./Progression.md)** — *Прогрессия.* Вертикаль роста во времени: как меняется восприятие игрока от первого часа до финала. Укрупнение Взгляда, Качественный Порог, четыре петли времени, калибровка под четыре типа игр OGD.
