...
- **[`Pacing.md`](./Pacing.md)** — *Пейсинг.* Ритм и распределение событий в моменте: как настроить пять слоёв опыта, чтобы игрок не уставал от хаоса и не засыпал от порядка. Принцип Убывающей Редкости, рассинхронизация слоёв.
