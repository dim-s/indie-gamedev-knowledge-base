...
2. **Инструменты:** 6 типов механик для управления состоянием игрока.
3. **Практика:** Пошаговые протоколы для анализа концепта, поиска аудитории и диагностики проблем вашей игры.

*Если времени мало, начните с раздела [TL;DR (В двух словах о методе)](./OGD.md#tldr-в-двух-словаха-о-методе) внутри основного документа.*
