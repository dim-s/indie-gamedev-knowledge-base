...
>
> Именно из этих наблюдений и размышлений родилась методология **[Organic Game Design (OGD)](../../OGD/OGD.md)**. То, что я описывал тогда интуитивно как «терапию», теперь стало инженерным понятием **[Игры-Убежища](../../OGD/OGD.md#ogd-game-shelter)**, восстанавливающей баланс игрока.
