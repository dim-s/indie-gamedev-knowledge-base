...
| Жанр (Якорь) | Ожидаемая Сфера (Где болит?) | Ожидаемый Инструмент (Что делать?) | Типичный вектор (По умолчанию) |
| :--- | :--- | :--- | :--- |
| **Shooter (FPS/TPS)** | **Сила** + Среда | **Подавить** (уничтожить угрозу) + Бросить вызов (скилл) | **Стимулятор** (адреналин, реакция). Если темп медленный (sniper) — может быть Стабилизатором (контроль). |
| **RPG (Role-Playing)** | **Познание** + Ресурсы + Среда | **Разобрать** (билды) + **Открыться** (мир) + Усложнить (прогрессия) | **Тренажёр** (рост силы и знаний). Но гринд или прогулки по миру могут работать как Убежище. |
| **Strategy (RTS/TBS)** | **Ресурсы** + Познание | **Упростить/Усложнить** (менеджмент) + Разобрать (тактика) | **Стимулятор** (напряжение ума). Если есть пауза и строительство — сдвигается в Убежище (мой город). |
| **Survival** | **Ресурсы** + Среда | **Обойти** (выжить, не умереть) + Закрыться (база) | **Стимулятор** (стресс дефицита). Как только база построена — становится Убежищем. |
| **Simulators / Farm** | **Ресурсы** + Среда | **Собрать** (урожай/коллекцию) + Упростить (рутина) | **Стабилизатор** (Убежище). Чистая терапия через предсказуемый труд. |
| **Platformer** | **Среда** | **Бросить вызов** (ловкость) + Обойти (препятствия) | **Стимулятор** (Flow, реакция). |
| **Puzzle** | **Познание** | **Разобрать** (понять логику) + Собрать (порядок) | **Стабилизатор** (ясность, инсайт). Но сложные пазлы — это Стимулятор (вызов интеллекту). |
| **Horror** | **Среда** + Шанс | **Открыться** (идти в темноту) + Обойти (избегать монстра) | **Стимулятор** (чистый Хаос). Игрок платит за дозу контролируемого страха. |
| **Visual Novel** | **Социум** + Познание | **Сблизиться** (эмпатия) + Разобрать (сюжет) | **Стабилизатор** (если романтика) или Стимулятор (если драма/детектив). |
| **Rogue-like** | **Шанс** + Познание | **Рискнуть** (адаптация) + Разобрать (новые правила) | **Стимулятор** (адреналин, высокая цена ошибки). |
| **MOBA** | **Сила** + Социум | **Бросить вызов** (скилл) + Сблизиться (команда) / Подавить | **Стимулятор** (соревнование). Высочайшая цена социальной ошибки. |
| **Battle Royale** | **Сила** + Среда + Шанс | **Обойти** (выжить) + Рискнуть (лут) + Подавить | **Стимулятор** (адреналин выживания). |
| **Gacha** | **Шанс** + Социум + Ресурсы | **Рискнуть** (крутки) + Сблизиться (вайфу) + Упростить (дейлики) | **Стабилизатор** (ритм привычки) с пиками Стимуляции (азарт). |
| **Sandbox (Creative)** | **Среда** + Познание | **Открыться** (свобода) + Усложнить (творчество) | **Убежище** (полный контроль). Но без цели может стать Хаосом для новичка. |
