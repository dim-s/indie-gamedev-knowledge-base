...
*Методология создания игр, которые встраиваются в жизнь игрока.*
...
Мы спрашиваем: «Какой дефицит в жизни игрока она восполняет?».
...
- [Послесловие](#послесловие)
    - [Зачем создан OGD](#зачем-создан-ogd)
...
Цель такой игры — удержание любой ценой (Retention).
...
Их метод — **уважение** к времени игрока.
После сессии игрок чувствует себя восстановленным, «сытым» и довольным.
Цель такой игры — возвращение через доверие.

> [!NOTE]
> **Экономический эффект**
>
> - **Синтетика** чаще требует постоянной закупки рекламного трафика: людям сложно искренне советовать опыт, после которого они сами чувствуют истощение или стыд.
> - **Органика** растёт через сарафан и органический трафик: игроки делятся игрой как полезным опытом (“тебе стоит попробовать, это реально помогает”).
...
SDT/PENS в этом месте решает другую задачу. Она хорошо объясняет три базовые потребности на уровне переживания — почему игроку становится «хорошо». OGD опирается на эту логику в фундаменте выше по тексту. А здесь нам важно связать запрос игрока с типом игрового опыта и конкретными механиками, поэтому и нужна карта областей жизни.
...
> [!NOTE]
> Гендер в OGD не выделяется в отдельную ось.
>
...
Ниже идут типовые профили для каждой эпохи. Каждый профиль описан одинаково: контекст → доминирующая Сфера и полюс (Хаос/Порядок) → тип игры → Инструменты (глаголы OGD) → механики‑якоря.
...
Ниже — образ мысли, который лежит в основе этого метода.

### Зачем создан OGD

В основе метода лежит простая идея: деньги, внимание и высокие оценки — не цель разработки, а побочный эффект совпадения продукта с потребностью аудитории. OGD создавался как ответ на кризис геймдизайна, ориентированного в первую очередь на метрики, где игрок воспринимается как источник времени/внимания. Наша цель иная: создавать продукт, который дает человеку то, чего ему не хватает в реальности, и делает это без принуждения. Когда игра становится для человека не просто “занятием времени”, а стабильным способом восстановить баланс, он платит за неё не потому, что его подтолкнули механики монетизации, а потому что ценность очевидна. Это путь к созданию проектов, к которым возвращаются годами.

### Реальность как источник инноваций

Мы не ищем идеи для игр, просто копируя чужие механики. Мы смотрим на реальную жизнь. Если мир стал слишком одиноким и разобщенным, мы понимаем: может вырасти спрос на кооперацию и чувство принадлежности. Инновация в OGD — это своевременный ответ на новый дефицит общества. Даже когда мы анализируем чужие хиты, мы смотрим на них как исследователи: "Какую потребность закрывает эта игра? Почему миллионы людей выбрали именно этот опыт?". Понимание запроса позволяет нам создать не просто клон, а более точный продукт.
