---
layout: default
title: "Кейс: Balatro vs Durak"
parent: Геймдизайн
---

# Кейс: Balatro vs Durak. Как сделать игру на базе нашей игры в "Дурака" и продать её миру

> Основано на посте в моем тг канале: [Дмитрий Зайцев | Геймдизайн Тихой Гавани](https://t.me/dima_zaitsev_gamedev/77)
...
> [!TIP]
> В документации по [OGD](../../OGD/OGD.md) есть раздел справочника игровых сеттингов в сочетании с доминирующей сферой игры, раздел [Карта ожиданий сеттинга](../../OGD/OGD.md#ogd-setting-expectations), которая помогает точнее подобрать сеттинг игры.
...
> [!WARNING]
> Это главная проблема концепции, которую должен решить геймдизайнер, чтобы игрок не был фрустирован правилами Дурака. 
