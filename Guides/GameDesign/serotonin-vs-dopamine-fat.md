---
layout: default
title: "Дофаминовый vs Сератониновый жир"
parent: Геймдизайн
---
...
> *   **[Органическая Игра](../../OGD/OGD.md#ogd-organic-vs-synthetic)** = Игра, которая *питает* (восстанавливает ресурс).
...
>
> Ограничение в 3-4 чанка — это биологическое обоснование для использования **[Инструментов Структуры](../../OGD/OGD.md#ogd-tools-structure)** (Сфера Познания). Когда мы даем игроку 10 выборов, мы создаем **Хаос**. Когда мы ограничиваем выбор до 3-х карт, мы создаем **Порядок**.
>
...
> [!NOTE]
> **Игра-Убежище (Органика)**
>
> "Сератониновый жир" в терминологии OGD — это классический эффект **[Органической Игры-Убежища](../../OGD/OGD.md#ogd-game-shelter)**.
>
