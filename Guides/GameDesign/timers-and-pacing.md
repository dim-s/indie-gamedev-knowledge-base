...
> Возможность контролировать время — это чистая **[Агентность](../../OGD/OGD.md#агентность-и-инструменты-ogd)** (способность влиять на мир).
>
> Когда игра отбирает у игрока контроль над темпом, она бьет по потребности в Автономии. Игрок чувствует себя не субъектом, который решает задачи, а объектом, которого подгоняют. В **[Игре-Убежище](../../OGD/OGD.md#игра-убежище)** это недопустимо.
...
> Эти исключения относятся к **[Играм-Тренажёрам](../../OGD/OGD.md#игра-тренажёр)** или **Маятникам**. В таких играх стресс и выброс адреналина (Стимуляция) являются частью «контракта» с игроком. Игрок *хочет* испытать напряжение, чтобы потом получить разрядку (дофаминовый пик).
>
...
> Аудитория Cozy-игр часто пересекается с профилем **«Уставший взрослый»** (см. [Справочник аудиторий](../../OGD/OGD.md#справочник-аудиторий-по-эпохам-жизни)). Их Сфера Ресурсов (силы, внимание) и так истощена реальностью.
>
