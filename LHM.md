...
Практический фреймворк (гайд) для создания **успешных игровых проектов**. Помогает спроектировать геймплей и концепцию игры "которая продает сама себя", для точного попадания в рынок и в желания игроков.
...
- [Приложение: Ограничения и контр-аргументы](#приложение-ограничения-и-контр-аргументы)
    - [Карта уверенности модели](#карта-уверенности-модели)
...
- [**Принцип свободной энергии**](https://en.wikipedia.org/wiki/Free_energy_principle) (Free Energy Principle): описывает организм как предсказывающую систему, которая стремится снижать “сюрприз” (неожиданность сенсорных входов) за счёт уточнения внутренних моделей и действий.
    - *LHM использует это как интерпретативную рамку: у человека есть устойчивое стремление снижать неопределённость и возвращаться к рабочему равновесию, а игры могут быть одним из инструментов такой саморегуляции.*
- [**Теория когнитивной нагрузки**](https://ru.wikipedia.org/wiki/Теория_когнитивной_нагрузки) (**Cognitive load theory**) и *когнитивная психология:* помогают понять, почему человек играет в игры, как люди получают знания и опыт, а также почему мозг перегружается и «ленится» что-либо менять и пробовать новое.
    - *LHM использует эту теорию, чтобы объяснить барьер входа: когда новая игра требует много “оперативного внимания” (новые правила, интерфейс, действия), часть аудитории будет избегать такого старта и тянуться к более знакомым паттернам опыта.*
- [Пирамида Маслоу](https://ru.wikipedia.org/wiki/Пирамида_потребностей_по_Маслоу) (в маркетинге) и **[теория ERG](https://ru.wikipedia.org/wiki/Теория_ERG_Альдерфера)** (Клейтона Альдерфера) в психологии: это популярные “языки” классификации человеческих потребностей. Пирамида Маслоу считается устаревшей в научном смысле, а ERG часто рассматривают как её более гибкую альтернативу (без жёсткой лестницы).
    - *LHM использует ERG прежде всего как **классификатор/таксономию** (удобную группировку “что болит”), а не как доказательство. Ядро объяснительной силы модели в другом: SDT (Агентность/связность) + когнитивная нагрузка (барьер входа) + практические предсказания про диссонанс и трение.*
...
> LHM объединяет их так: игру можно рассматривать как один из инструментов саморегуляции, который помогает снижать субъективную неопределённость (в рамках predictive processing / Free Energy Principle), возвращает Агентность и связность (SDT) и удерживает в состоянии оптимального вызова (поток, Flow теория). ERG здесь выступает как язык группировки “о чём дефицит”, а не как “доказательная база”.
> 
...
В основе здесь лежит ERG как удобная группировка потребностей — именно как классификатор, а не как “фундамент доказательности”. Но для проектирования нам нужна чуть более точная «нарезка», поэтому LHM раскладывает это на пять Сфер: Познание, Среда, Сила, Ресурсы, Социум.
...
Жанр и сеттинг — это первый слой обещания. Игрок считывает его раньше, чем успевает вникнуть в детали. Это работает на уровне инстинктов: еще до того, как пользователь поймет, в чем ваша "уникальность", он уже составил первое впечатление.

Жанр отвечает на вопрос "как я буду играть". Это якорь, который опирается на привычки: темп, управление, базовый цикл действий. Когда мы говорим "шутер", "симулятор фермы" или "выживач", мы резко снижаем порог входа. Игроку не нужно заново учиться ходить или открывать инвентарь.

Люди часто ругают игры за вторичность, но на практике выбирают знакомое. И дело не в любви к банальности, а в банальной экономии сил. Знакомый жанр — это отсутствие трения на старте.

Сеттинг отвечает на вопрос "про что это ощущение". Роботы, эльфы, уютная кухня или мрачный лес — это не просто картинки. Это сигналы, которые настраивают игрока на определенный лад.
...
Представьте игру про огромных боевых роботов. Игрок ждет "Силу" (сражения) или "Познание" (сборку мехов). Если внутри оказывается симулятор свиданий, происходит диссонанс. Даже если диалоги написаны гениально, игрок чувствует себя обманутым — его изначальный запрос проигнорирован.
...
*Научное обоснование (через LHM и когнитивистику):*
...
Этот раздел — про гигиену мышления.
...
LHM — инженерная макро‑модель. Её сила в скорости: наметить правдоподобное объяснение, сделать предсказание и проверить его на игроках. Не выиграть спор ссылками.
...
Практический вывод для LHM: Flow — компас для ритма нагрузки, а не калькулятор.
...
Практический вывод для LHM: “мягкая посадка” важна, но она не спасёт сессию, которая целиком была трением и утомлением.
...
Практический вывод для LHM: “окна выхода” и “парковка” работают не через “магическую память”, а через снятие напряжения незакрытого контекста.
...
Практический вывод для LHM: “когнитивный ресурс” — удобная прикладная метафора. Не биохимия и не обещание точных измерений.
...
Практический вывод для LHM: читабельность и ясность снижают воспринимаемый риск у массовой аудитории. Это ориентир, а не универсальный рецепт (и не гарантия качества).
...
Практический вывод для LHM: FEP полезен как линза про неопределённость. Его нельзя использовать как “доказательство” любого психологического утверждения.
...
Практический вывод для LHM: социальное доказательство — сильный рычаг для массовой аудитории, но у него есть модераторы и обратные эффекты (“слишком мейнстрим”, “не про меня”).
