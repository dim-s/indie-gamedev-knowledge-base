...
Викарная агентность работает, только если произошла «сцепка» (идентификация) игрока с героем. В зависимости от типа сцепки, нарратив выполняет разные задачи (на основе работ Cohen, 2001; Downs et al., 2004).
